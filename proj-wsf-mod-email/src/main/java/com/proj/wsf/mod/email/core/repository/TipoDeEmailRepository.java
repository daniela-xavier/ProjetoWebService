...
/**
 * Description the class  TipoDeEmailRepository - xxxxx
 * @author Daniela Xavier Conceição - sistemas@fozadvogados.com.br
 * @version $v rev. $rev  $Revision$
 * @since Build 1.1 19/02/2019
 */
@Component("tipoDeEmailRepository")
public class TipoDeEmailRepository implements IRepository {
