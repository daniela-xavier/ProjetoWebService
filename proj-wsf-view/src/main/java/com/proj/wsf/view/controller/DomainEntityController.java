...
/**
 * Description the class DomainEntityController - Classe responsÃ©vel pela
 * execuÃ§Ã£o das aÃ§Ã£es, de acordo com mÃ©todos HTTP.
 *
 * @author Daniela Xavier ConceiÃ§Ã£o - sistemas@fozadvogados.com.br
    ...
    ResponseEntity deleteEntity(@PathVariable Optional<String> id) {
        ...
        try {
            ...
            if (id.isPresent()) {
                ...
                return new ResponseEntity<>(
                        new ResponseMessage(Boolean.TRUE, "Item id obrigatório"),
                        HttpStatus.INTERNAL_SERVER_ERROR);
            }
